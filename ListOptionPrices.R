...
# filters: keep only options with volume >= 1
...
# load SPY options data on 9-Feb-2026
allData <- read.csv(file = 'SPY_options_9Feb2026.csv')
...
Fwd.OM <- data.frame("date"=oneDay,"expiration"=datesExpiry,
                     "ForwardPrice"=Fwd)
head(Fwd.OM)
#write.csv(Fwd.OM, file="SPY_forwards_9Feb2026.csv")
